...
TEST(Des, DESede_CBC_PKCS5Padding)
{
	...
	encrypt = Des::encrypt(plain, key, Des::CipherMode::CBC, Des::PaddingScheme::PKCS5Padding);
...
TEST(Des, DESede_CFB_PKCS5Padding)
{
	...
	plain = Base64::decode("GcRqZtvZqfz0nww=");
	encrypt = Des::encrypt(plain, key, Des::CipherMode::CFB, Des::PaddingScheme::PKCS5Padding);
...
TEST(Des, DESede_CTR_PKCS5Padding)
{
	...
	plain = Base64::decode("GcRqZtvZqfz0nww=");
	encrypt = Des::encrypt(plain, key, Des::CipherMode::CTR, Des::PaddingScheme::PKCS5Padding);
...
TEST(Des, DESede_CTS_ZeroPadding)
{
	...
	plain = Base64::decode("GcRqZtvZqfz0nww=");
	encrypt = Des::encrypt(plain, key, Des::CipherMode::CTS, Des::PaddingScheme::ZeroPadding);
...
TEST(Des, DESede_ECB_PKCS5Padding)
{
	...
	plain = Base64::decode("GcRqZtvZqfz0nww=");
	encrypt = Des::encrypt(plain, key, Des::CipherMode::ECB, Des::PaddingScheme::PKCS5Padding);
...
TEST(Des, DESede_OFB_PKCS5Padding)
{
	...
	plain = Base64::decode("GcRqZtvZqfz0nww=");
	encrypt = Des::encrypt(plain, key, Des::CipherMode::OFB, Des::PaddingScheme::PKCS5Padding);
