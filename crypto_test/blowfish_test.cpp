...
TEST(Blowfish, CBC_PKCS5Padding)
{
	...
	encrypt = Blowfish::encrypt(plain, key, Blowfish::CipherMode::CBC, Blowfish::PaddingScheme::PKCS5Padding);
...
TEST(Blowfish, CFB_PKCS5Padding)
{
	...
	plain = Base64::decode("GcRqZtvZqfz0nww=");
	encrypt = Blowfish::encrypt(plain, key, Blowfish::CipherMode::CFB, Blowfish::PaddingScheme::PKCS5Padding);
...
TEST(Blowfish, CTR_NoPadding)
{
	...
	plain = Base64::decode("GcRqZtvZqfz0nww=");
	encrypt = Blowfish::encrypt(plain, key, Blowfish::CipherMode::CTR, Blowfish::PaddingScheme::NoPadding);
...
TEST(Blowfish, CTS_ZeroPadding)
{
	...
	plain = Base64::decode("GcRqZtvZqfz0nww=");
	encrypt = Blowfish::encrypt(plain, key, Blowfish::CipherMode::CTS, Blowfish::PaddingScheme::ZeroPadding);
...
TEST(Blowfish, ECB_PKCS5Padding)
{
	...
	plain = Base64::decode("GcRqZtvZqfz0nww=");
	encrypt = Blowfish::encrypt(plain, key, Blowfish::CipherMode::ECB, Blowfish::PaddingScheme::PKCS5Padding);
...
TEST(Blowfish, OFB_PKCS5Padding)
{
	...
	plain = Base64::decode("GcRqZtvZqfz0nww=");
	encrypt = Blowfish::encrypt(plain, key, Blowfish::CipherMode::OFB, Blowfish::PaddingScheme::PKCS5Padding);
