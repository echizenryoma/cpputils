...
TEST(Aes, AES_128_CBC_PKCS5Padding)
{
	...
	encrypt = Aes::encrypt(plain, key, Aes::CipherMode::CBC, Aes::PaddingScheme::PKCS5_Padding);
...
TEST(Aes, AES_128_CFB_PKCS5Padding)
{
	...
	plain = Base64::decode("GcRqZtvZqfz0nww=");
	encrypt = Aes::encrypt(plain, key, Aes::CipherMode::CFB, Aes::PaddingScheme::PKCS5_Padding);
...
TEST(Aes, AES_128_CTR_NoPadding)
{
	...
	plain = Base64::decode("GcRqZtvZqfz0nww=");
	encrypt = Aes::encrypt(plain, key, Aes::CipherMode::CTR, Aes::PaddingScheme::No_Padding);
...
TEST(Aes, AES_128_CTS_ZeroPadding)
{
	...
	plain = Base64::decode("GcRqZtvZqfz0nww=");
	encrypt = Aes::encrypt(plain, key, Aes::CipherMode::CTS, Aes::PaddingScheme::Zero_Padding);
...
TEST(Aes, AES_128_ECB_PKCS5Padding)
{
	...
	plain = Base64::decode("GcRqZtvZqfz0nww=");
	encrypt = Aes::encrypt(plain, key, Aes::CipherMode::ECB, Aes::PaddingScheme::PKCS5_Padding);
	EXPECT_EQ("1u9HjUFAEFOQeiP361vzgA==", Base64::encode(encrypt));
...
TEST(Aes, AES_128_OFB_PKCS5Padding)
{
	...
	key = Base64::decode("LbpWRuZIvD1a/dA9GVs2LQ==");
	plain = Base64::decode("GcRqZtvZqfz0nww=");
	encrypt = Aes::encrypt(plain, key, Aes::CipherMode::OFB, Aes::PaddingScheme::PKCS5_Padding);
	EXPECT_EQ("ntzGj2yhERTULzjEogILLw==", Base64::encode(encrypt));
...
TEST(Aes, AES_128_GCM_NoPadding)
{
	...
	key = Base64::decode("LbpWRuZIvD1a/dA9GVs2LQ==");
	plain = Base64::decode("GcRqZtvZqfz0nww=");
	encrypt = Aes::encrypt(plain, key, Aes::CipherMode::GCM, Aes::PaddingScheme::No_Padding);
